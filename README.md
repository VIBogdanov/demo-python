...
### **puzzles**  
Решения интересных задач, напримар, олимпиадных или просто заковыристых.
...
- ***get_common_divisor*** - Алгоритм нахождения наибольшего общего делителя двух целых чисел. Используется метод Евклида.
