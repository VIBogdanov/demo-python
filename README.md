...
- ***sort_by_shell*** - Сортировка списка методом Shell. Реализована двунаправленная сортировка. Кроме классического метода формирования диапазона чисел для перестановки, возможно использовать следующие методы: Hibbard, Sedgewick, Knuth, Fibonacci.