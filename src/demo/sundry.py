...
def sort_by_merge3(
    ...
    while query_work:
        ...
        # Счетчик смещений для элементов перемещенных из левой половины в правую
        i_counter: int = 0
        ...
        while i_left < i_right and i_right < i_last:
            if (
                ...
                if i_current == i_left:
                    ...
                    # Иначе наращиваем счетчик перемещенных элементов. Счетчик всегда на единицу меньше.
                    i_counter += 1
                i_right += 1
            else:
                ...
                if i_current == i_left:
                    ...
                    i_left += int(i_counter > 0)
                # Если элемент из левой части, хранящийся в правой, использован, декремируем счетчик
                if i_counter > 0:
                    i_counter -= 1
